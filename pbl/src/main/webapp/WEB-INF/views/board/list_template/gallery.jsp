    ...
    <div class="col">
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-body d-flex flex-column">
          ...
          <p class="card-text text-muted mb-1 small"><i class="fa-regular fa-calendar"></i> ${b.regdate }</p>
          <p class="card-text text-muted mb-1 small"><i class="fa-regular fa-eye"></i> ${b.cnt}</p>
